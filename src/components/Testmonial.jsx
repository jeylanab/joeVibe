...
const Testmonial = () => {
  ...
  useEffect(() => {
    const increment = Math.ceil(targetNumber / 100); // Define the increment step
      ...
      <div className='card-item mx-[100px]'>
        <div className='side-card'>
          <h1 className='text-center text-2xl font-medium p-3'>
            Join <span className='text-shadow text-4xl font-bold'>{currentNumber.toLocaleString()}+ </span>  
